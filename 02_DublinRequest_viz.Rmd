...
#for(lang in colnames(txt)) {
  ...
  footer <- paste0("source: ", htmlLink("http://appsso.eurostat.ec.europa.eu/nui/show.do?dataset=migr_dubredaco&lang=en", "Eurostat"),
                  " | swissinfo.ch")
  
  save_html(
    fluidPage(
     tags$h2("La Suisse championne de requêtes Dublin infondées"), #txt['title1', lang]),
    div(class = "descr", "Proportion des requêtes sortantes Dublin non-Eurodac par pays de 2008 à 2015"), #txt['desc', lang]),
